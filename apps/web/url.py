...
from apps.tools import views as toolsviews
import re
...
urlpatterns = [
    ...
    re_path(re.compile(r'^((?P<Shorten_kategori>[\w-]+)/(?P<Shorten_ShortenWord>[\w-]+)/)$', re.IGNORECASE), webviews.redirect_view, name='redirect'),
]   