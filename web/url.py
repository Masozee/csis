...
urlpatterns = [
    ...
    path('events/detail', TemplateView.as_view(template_name='web/home-grid.html'), name='event-detail'),
    ...
    path('news/detail', TemplateView.as_view(template_name='web/home-grid.html'), name='news-detail'),
    path('faq/', TemplateView.as_view(template_name='web/home-grid.html'), name='faq'),
